...
namespace PNC
{
    ...
    //    using ArrayExtension_t = ChunkArrayExtensionT<ChunkStructure_t, ChunkPointerElement_t>;
    ...
    //        : Base_t(ChunkKind::ChunkArrayTree)
    //    {
    //    }
    ...
    //        : Base_t(chunkStructure, componentData, totalNodeCount, ChunkKind::ChunkArrayTree)
    ...
    //    //KChunkArrayTreePointerT(const ChunkStructure_t* chunkStructure, const Size_t chunkCount, const Size_t nodeCountPerChunk)
    //    //    : Base_t(ChunkKind::ChunkArrayTree, chunkStructure, chunkCount * nodeCountPerChunk)
    //    //    , Array(chunkCount)
    //    //{
    //    //}
    //    KChunkArrayTreePointerT(const ChunkStructure_t* chunkStructure, const Size_t chunkCount, const Size_t nodeCountPerChunk, ChunkKind kind = ChunkKind::ChunkArrayTree)

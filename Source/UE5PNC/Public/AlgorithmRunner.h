...
namespace PNC
{
    ...
    template<typename TChunkType, typename TChunkAlgorithm, typename TKChunkPointer = KindPointerT<TChunkType>>
    struct AlgorithmRunner : public AlgorithmRunnerKindPointerSwitch<TChunkType, TChunkAlgorithm>
    {
    };
}
